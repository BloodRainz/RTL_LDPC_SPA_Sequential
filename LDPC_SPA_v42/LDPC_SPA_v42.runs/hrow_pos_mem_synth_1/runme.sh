...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v29/LDPC_SPA_v29.runs/hrow_pos_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hrow_pos_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hrow_pos_mem.tcl
