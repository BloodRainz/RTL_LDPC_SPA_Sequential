...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v37/LDPC_SPA_v37.runs/Lji_mem_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lji_mem_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lji_mem_bram.tcl
