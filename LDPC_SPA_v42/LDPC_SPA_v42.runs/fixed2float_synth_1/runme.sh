...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v17_1/LDPC_SPA_v17_1.runs/fixed2float_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed2float.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fixed2float.tcl
