...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v37/LDPC_SPA_v37.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPA_top_v3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPA_top_v3.tcl
