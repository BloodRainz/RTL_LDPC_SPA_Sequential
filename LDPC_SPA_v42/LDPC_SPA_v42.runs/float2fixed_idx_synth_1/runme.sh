...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v37/LDPC_SPA_v37.runs/float2fixed_idx_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float2fixed_idx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float2fixed_idx.tcl
