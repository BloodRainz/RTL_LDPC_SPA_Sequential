...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v37/LDPC_SPA_v37.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPA_top_v3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPA_top_v3.tcl -notrace
