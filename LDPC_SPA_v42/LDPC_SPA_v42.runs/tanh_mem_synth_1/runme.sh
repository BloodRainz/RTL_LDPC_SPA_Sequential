...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v33/LDPC_SPA_v33.runs/tanh_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tanh_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tanh_mem.tcl
