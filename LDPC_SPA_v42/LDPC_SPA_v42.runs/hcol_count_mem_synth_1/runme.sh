...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v29/LDPC_SPA_v29.runs/hcol_count_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hcol_count_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hcol_count_mem.tcl
