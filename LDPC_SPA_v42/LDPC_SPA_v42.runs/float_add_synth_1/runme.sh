...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v23/LDPC_SPA_v23.runs/float_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_add.tcl
