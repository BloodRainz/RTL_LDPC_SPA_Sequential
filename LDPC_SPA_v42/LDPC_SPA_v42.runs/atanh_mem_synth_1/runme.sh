...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v34/LDPC_SPA_v34.runs/atanh_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atanh_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atanh_mem.tcl
