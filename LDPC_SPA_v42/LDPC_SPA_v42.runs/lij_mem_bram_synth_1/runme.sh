...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v36/LDPC_SPA_v36.runs/lij_mem_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lij_mem_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lij_mem_bram.tcl
