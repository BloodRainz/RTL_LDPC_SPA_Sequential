...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v23/LDPC_SPA_v23.runs/floating_mul_half_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_mul_half.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_mul_half.tcl
