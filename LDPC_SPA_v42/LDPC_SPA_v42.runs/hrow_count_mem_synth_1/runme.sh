...
HD_PWD='D:/Vivado_files/Master_thesis/LDPC_SPA_v29/LDPC_SPA_v29.runs/hrow_count_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hrow_count_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hrow_count_mem.tcl
