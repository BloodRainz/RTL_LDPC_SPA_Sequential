...
#                script (type 'tanh_mem.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tanh_mem xil_defaultlib.glbl -o tanh_mem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tanh_mem_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tanh_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tanh_mem_simv.daidir vcs_lib c.obj)
