...
#
# Script generated by Vivado on Thu Aug 07 19:35:31 +0200 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tanh_mem.sh
...
#
# Usage        : tanh_mem.sh
#                tanh_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tanh_mem.sh [-reset_run]
#                tanh_mem.sh [-reset_log]
#                tanh_mem.sh [-help]
#
...
# script info
echo -e "tanh_mem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tanh_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tanh_mem xil_defaultlib.tanh_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tanh_mem -key {Behavioral:sim_1:Functional:tanh_mem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tanh_mem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tanh_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tanh_mem.sh [-help]\n\
Usage: tanh_mem.sh [-step]\n\
Usage: tanh_mem.sh [-lib_map_path]\n\
Usage: tanh_mem.sh [-reset_run]\n\
Usage: tanh_mem.sh [-reset_log]\n\
Usage: tanh_mem.sh [-keep_index]\n\
Usage: tanh_mem.sh [-noclean_files]\n\n\
