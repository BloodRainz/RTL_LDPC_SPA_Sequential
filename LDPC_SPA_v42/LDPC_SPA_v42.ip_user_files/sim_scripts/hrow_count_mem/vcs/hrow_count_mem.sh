...
#
# Script generated by Vivado on Thu Aug 07 19:35:27 +0200 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : hrow_count_mem.sh
...
#
# Usage        : hrow_count_mem.sh
#                hrow_count_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                hrow_count_mem.sh [-reset_run]
#                hrow_count_mem.sh [-reset_log]
#                hrow_count_mem.sh [-help]
#
...
#                script (type 'hrow_count_mem.sh -help' for more information).
#
...
# script info
echo -e "hrow_count_mem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./hrow_count_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.hrow_count_mem xil_defaultlib.glbl -o hrow_count_mem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./hrow_count_mem_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key hrow_count_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc hrow_count_mem_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./hrow_count_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: hrow_count_mem.sh [-help]\n\
Usage: hrow_count_mem.sh [-step]\n\
Usage: hrow_count_mem.sh [-lib_map_path]\n\
Usage: hrow_count_mem.sh [-reset_run]\n\
Usage: hrow_count_mem.sh [-reset_log]\n\
Usage: hrow_count_mem.sh [-keep_index]\n\
Usage: hrow_count_mem.sh [-noclean_files]\n\n\
