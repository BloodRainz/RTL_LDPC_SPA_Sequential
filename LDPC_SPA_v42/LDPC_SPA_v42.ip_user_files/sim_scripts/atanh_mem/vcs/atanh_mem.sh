...
#                script (type 'atanh_mem.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.atanh_mem xil_defaultlib.glbl -o atanh_mem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./atanh_mem_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key atanh_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc atanh_mem_simv.daidir vcs_lib c.obj)
