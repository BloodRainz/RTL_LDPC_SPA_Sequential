...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.llr_sn6_full xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.llr_sn6_full -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log llr_sn6_full_sc.so .tmp_log xcelium_lib waves.shm c.obj)
