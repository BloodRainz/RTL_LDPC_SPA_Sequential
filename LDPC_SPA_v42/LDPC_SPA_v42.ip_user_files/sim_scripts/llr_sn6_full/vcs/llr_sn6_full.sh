...
#
# Script generated by Vivado on Tue Aug 05 00:56:57 +0200 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : llr_sn6_full.sh
...
#
# Usage        : llr_sn6_full.sh
#                llr_sn6_full.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                llr_sn6_full.sh [-reset_run]
#                llr_sn6_full.sh [-reset_log]
#                llr_sn6_full.sh [-help]
#
...
#                script (type 'llr_sn6_full.sh -help' for more information).
#
...
# script info
echo -e "llr_sn6_full.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./llr_sn6_full.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.llr_sn6_full xil_defaultlib.glbl -o llr_sn6_full_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./llr_sn6_full_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key llr_sn6_full_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc llr_sn6_full_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./llr_sn6_full.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: llr_sn6_full.sh [-help]\n\
Usage: llr_sn6_full.sh [-step]\n\
Usage: llr_sn6_full.sh [-lib_map_path]\n\
Usage: llr_sn6_full.sh [-reset_run]\n\
Usage: llr_sn6_full.sh [-reset_log]\n\
Usage: llr_sn6_full.sh [-keep_index]\n\
Usage: llr_sn6_full.sh [-noclean_files]\n\n\
