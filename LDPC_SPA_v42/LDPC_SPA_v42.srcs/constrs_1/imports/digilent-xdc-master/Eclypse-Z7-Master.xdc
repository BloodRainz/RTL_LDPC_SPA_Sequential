...
## Buttons
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { start_btn }]; #IO_L11P_T1_SRCC Sch=btn[0]
set_property -dict { PACKAGE_PIN C18   IOSTANDARD LVCMOS33 } [get_ports { rst_btn }]; #IO_L11N_T1_SRCC Sch=btn[1]
...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { ja[0] }]; #IO_L7N_T1_AD2N Sch=ja1_fpga
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { ja[1] }]; #IO_L7P_T1_AD2P Sch=ja2_fpga
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { ja[2] }]; #IO_L3N_T0_DQS_AD1N Sch=ja3_fpga
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { ja[3] }]; #IO_L1N_T0_AD0N Sch=ja4_fpga
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { ja[4] }]; #IO_L3P_T0_DQS_AD1P Sch=ja7_fpga
#set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { ja[5] }]; #IO_L6N_T0_VREF Sch=ja8_fpga
